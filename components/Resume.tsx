...
import { 
  ...
  Github, Linkedin, ArrowRight, LayoutGrid
} from 'lucide-react';
    ...
    <div className="min-h-screen pt-28 pb-20 bg-slate-50 dark:bg-dark relative overflow-hidden font-sans text-slate-800 dark:text-slate-200 transition-colors duration-300">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        ...
        <motion.div 
          ...
          animate="visible"
          variants={fadeInUp}
          className="glass-panel rounded-3xl p-8 md:p-12 mb-10 border border-slate-200 dark:border-white/10 relative overflow-hidden shadow-2xl group/header hover:shadow-[0_0_40px_rgba(168,85,247,0.15)] transition-shadow duration-500 bg-white/70 dark:bg-white/5"
        >
          ...
          <div className="relative z-10 flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="relative w-32 h-32 md:w-48 md:h-48 shrink-0 rounded-full border-4 border-white/50 dark:border-white/10 overflow-hidden shadow-xl bg-gradient-to-br from-purple-500 to-orange-500 p-1 group/image hover:scale-105 transition-transform duration-500 hover:shadow-[0_0_30px_rgba(249,115,22,0.4)]">
               <div className="w-full h-full rounded-full overflow-hidden bg-slate-100 dark:bg-black">
                   <img 
            ...
            <div className="flex-grow w-full">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-2 gap-x-6 text-slate-600 dark:text-gray-300 text-sm border-t border-slate-200 dark:border-white/10 pt-6 mt-2">
              ...
              <div className="flex flex-wrap gap-y-2 gap-x-6 mt-4 pt-4 border-t border-slate-200 dark:border-white/10 text-xs text-slate-500 dark:text-gray-500 uppercase tracking-wider">
        ...
        <motion.div 
            ...
            viewport={{ once: true }}
            variants={fadeInUp}
            className="glass-panel p-8 rounded-3xl border border-slate-200 dark:border-white/5 mb-10 hover:border-orange-500/30 hover:shadow-[0_0_30px_rgba(249,115,22,0.1)] transition-all duration-500 bg-white/70 dark:bg-white/5"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 space-y-10">
            ...
            >
                ...
                <div className="space-y-10">
                    ...
                    <div key={idx} className="relative pl-8 border-l-2 border-slate-200 dark:border-white/10 group">
                        ...
                        <p className="text-slate-600 dark:text-gray-300 text-sm leading-relaxed bg-white dark:bg-[#0f0f2d] p-5 rounded-2xl border border-slate-200 dark:border-white/5 hover:border-blue-500/30 hover:bg-slate-50 dark:hover:bg-white/5 hover:scale-[1.02] hover:shadow-[0_0_20px_rgba(59,130,246,0.15)] transition-all duration-300 shadow-sm">
                            {exp.description}
                        </p>
                    </div>
                    ))}
          ...
          <div className="lg:col-span-5 space-y-10">
            ...
            >
                ...
                <div className="grid gap-6">
                    {RESUME_DATA.education.map((edu, idx) => (
                        <div key={idx} className="bg-white dark:bg-[#0f0f2d] p-6 rounded-2xl border border-slate-200 dark:border-white/5 hover:border-purple-500/40 hover:bg-slate-50 dark:hover:bg-white/5 hover:scale-[1.03] hover:shadow-[0_0_20px_rgba(168,85,247,0.2)] transition-all duration-300 shadow-sm">
            ...
            <motion.section 
                ...
                viewport={{ once: true }}
                variants={fadeInUp}
                className="bg-white dark:bg-[#0f0f2d] p-6 rounded-3xl border border-slate-200 dark:border-white/5 hover:border-pink-500/20 hover:shadow-[0_0_20px_rgba(236,72,153,0.1)] transition-all duration-500 shadow-sm"
            >
                <div className="flex items-center gap-3 mb-6">
            ...
            <motion.section 
                ...
                viewport={{ once: true }}
                variants={fadeInUp}
                className="bg-white dark:bg-[#0f0f2d] p-6 rounded-3xl border border-slate-200 dark:border-white/5 hover:border-yellow-500/20 hover:shadow-[0_0_20px_rgba(234,179,8,0.1)] transition-all duration-500 shadow-sm"
            >
                <div className="flex items-center gap-3 mb-6">
            ...
            <motion.section 
                ...
                viewport={{ once: true }}
                variants={fadeInUp}
                className="bg-white dark:bg-[#0f0f2d] p-6 rounded-3xl border border-slate-200 dark:border-white/5 hover:border-green-500/20 hover:shadow-[0_0_20px_rgba(34,197,94,0.1)] transition-all duration-500 shadow-sm"
            >
                <div className="flex items-center gap-3 mb-6">
                ...
                <div className="mb-6">
                    ...
                    {RESUME_DATA.skills.technical.map((skill) => (
                        <span key={skill} className="px-3 py-1.5 bg-slate-100 dark:bg-black/40 text-slate-600 dark:text-gray-300 text-xs font-medium rounded-lg border border-slate-200 dark:border-white/5 hover:border-green-500/50 hover:text-green-600 dark:hover:text-green-300 hover:bg-green-500/10 hover:scale-110 hover:shadow-[0_0_15px_rgba(34,197,94,0.3)] transition-all duration-300 cursor-default">
                        {skill}
                        </span>
                    ))}
                    </div>
                ...
                <div>
                    ...
                    {RESUME_DATA.skills.soft.map((skill) => (
                        <span key={skill} className="px-3 py-1.5 bg-slate-100 dark:bg-black/40 text-slate-600 dark:text-gray-300 text-xs font-medium rounded-lg border border-slate-200 dark:border-white/5 hover:border-blue-500/50 hover:text-blue-600 dark:hover:text-blue-300 hover:bg-blue-500/10 hover:scale-110 hover:shadow-[0_0_15px_rgba(59,130,246,0.3)] transition-all duration-300 cursor-default">
                        {skill}
                        </span>
                    ))}
                    </div>
            ...
            <motion.section 
                ...
                viewport={{ once: true }}
                variants={fadeInUp}
                className="bg-white dark:bg-[#0f0f2d] p-6 rounded-3xl border border-slate-200 dark:border-white/5 shadow-sm"
            >
                <div className="flex items-center gap-3 mb-6">
                ...
                <div className="space-y-6">
                    ...
                    <div key={idx} className="p-4 rounded-xl bg-slate-50 dark:bg-black/20 border border-slate-200 dark:border-white/5 hover:scale-[1.02] hover:bg-white dark:hover:bg-white/5 hover:border-indigo-500/40 hover:shadow-[0_0_20px_rgba(99,102,241,0.2)] transition-all duration-300">
            ...
            <motion.section 
                ...
                viewport={{ once: true }}
                variants={fadeInUp}
                className="bg-white dark:bg-[#0f0f2d] p-6 rounded-3xl border border-slate-200 dark:border-white/5 hover:border-teal-500/20 hover:shadow-[0_0_20px_rgba(20,184,166,0.1)] transition-all duration-500 shadow-sm"
            >
                <div className="flex items-center gap-3 mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    <span key={hobby} className="px-3 py-1 bg-slate-100 dark:bg-black/40 rounded-full text-xs text-slate-500 dark:text-gray-400 border border-slate-200 dark:border-white/5 hover:scale-110 hover:border-teal-500/50 hover:text-teal-600 dark:hover:text-teal-300 hover:bg-teal-500/10 hover:shadow-[0_0_15px_rgba(20,184,166,0.3)] transition-all duration-300 cursor-default">
                        {hobby}
                    </span>
                    ))}
                </div>
