...
import { Download, ChevronRight, Brain, Database, Code2, LineChart, Server, Monitor, ChevronDown } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center relative z-10">
        <div className="space-y-8 text-center lg:text-left order-2 lg:order-1">
          ...
          <div className="flex justify-center lg:justify-start">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/40 dark:bg-white/5 border border-black/5 dark:border-white/10 text-purple-700 dark:text-purple-200 text-sm font-medium animate-fade-in backdrop-blur-xl shadow-lg shadow-purple-900/10 dark:shadow-purple-900/20 hover:bg-white/60 dark:hover:bg-white/40 hover:border-purple-500/30 dark:hover:border-white/80 hover:text-purple-900 dark:hover:text-white transition-all cursor-default hover:scale-105">
            ...
            {SOCIAL_LINKS.map((social) => {
              ...
              return (
                <a
                  ...
                  className={`
                    p-3.5 rounded-2xl transition-all duration-300 border border-black/5 dark:border-white/5
                    flex items-center justify-center bg-white/40 dark:bg-white/5 backdrop-blur-sm
                    ${active 
                      ? `${colorClass} hover:-translate-y-1 hover:shadow-lg cursor-pointer` 
          ...
          <div className="pt-8 grid grid-cols-2 gap-4 max-w-lg mx-auto lg:mx-0">
             {[
               ...
               { icon: Monitor, label: "C# & .NET", colorClass: "text-indigo-600 dark:text-indigo-400", hoverBorder: "hover:border-indigo-500/50", hoverBg: "hover:bg-indigo-500/10 dark:hover:bg-indigo-500/20", iconBg: "bg-indigo-500/10 dark:bg-indigo-500/20" },
                ...
                <div 
                  key={idx} 
                  className={`flex items-center gap-3 p-3 rounded-xl bg-white/60 dark:bg-white/5 border border-black/5 dark:border-white/5 transition-all duration-300 hover:scale-105 hover:shadow-lg group cursor-default ${item.hoverBorder} hover:bg-white/80 dark:hover:bg-white/10`}
                >
          ...
          <div className="relative group perspective-1000">
             ...
             <div className="relative w-72 h-72 sm:w-96 sm:h-96 transform rotate-3 transition-all duration-500 hover:rotate-0 hover:scale-[1.02]">
                <div className="absolute inset-0 bg-gradient-to-tr from-orange-400 via-purple-500 to-blue-500 rounded-[2.5rem] p-1 shadow-2xl">
                   <div className="h-full w-full bg-white dark:bg-[#0a0a0a] rounded-[2.3rem] overflow-hidden relative">
                      <img 
                ...
                <div className="absolute -top-6 -right-6 p-4 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md rounded-2xl border border-black/5 dark:border-white/10 shadow-xl animate-float" style={{animationDelay: '0.5s'}}>
                   <Brain className="text-purple-600 dark:text-purple-400 w-8 h-8" />
                </div>
                <div className="absolute -bottom-6 -left-6 p-4 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md rounded-2xl border border-black/5 dark:border-white/10 shadow-xl animate-float" style={{animationDelay: '1.5s'}}>
                   <Database className="text-orange-500 dark:text-orange-400 w-8 h-8" />
                </div>
             </div>
          </div>
        </div>
