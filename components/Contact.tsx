        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-start">
          ...
          >
            ...
            <div className="grid gap-4">
               <div className="p-6 rounded-2xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 hover:border-orange-500/30 transition-all group relative overflow-hidden shadow-sm hover:shadow-md">
               ...
               <div className="p-6 rounded-2xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 hover:border-purple-500/30 transition-all group relative overflow-hidden shadow-sm hover:shadow-md">
                   ...
                   return (
                     <a
                       ...
                       className={`
                         ...
                         ${active 
                           ? `bg-white dark:bg-white/5 border-slate-200 dark:border-white/5 hover:bg-slate-50 dark:hover:bg-white/10 hover:-translate-y-1 cursor-pointer ${styles.glow}` 
                           : 'bg-white dark:bg-white/5 border-slate-200 dark:border-white/5 cursor-default'
                         }
                       `}
                     >
          ...
          >
            <div className="glass-panel p-8 md:p-10 rounded-3xl border border-slate-200 dark:border-white/10 relative overflow-hidden bg-white/70 dark:bg-[#0f0f2d]/60 shadow-xl">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input 
                                  ...
                                  className="w-full bg-slate-50 dark:bg-black/20 border border-slate-200 dark:border-white/10 rounded-xl py-4 pl-12 pr-4 text-slate-800 dark:text-white placeholder-slate-400 dark:placeholder-gray-600 focus:outline-none focus:border-orange-500/50 focus:ring-1 focus:ring-orange-500/50 transition-all"
                                />
                            </div>
                        </div>
                        <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <textarea 
                              ...
                              placeholder=""
                              rows={5}
                              className="w-full bg-slate-50 dark:bg-black/20 border border-slate-200 dark:border-white/10 rounded-xl py-4 pl-12 pr-4 text-slate-800 dark:text-white placeholder-slate-400 dark:placeholder-gray-600 focus:outline-none focus:border-orange-500/50 focus:ring-1 focus:ring-orange-500/50 transition-all resize-none"
                            ></textarea>
                        </div>
                    </div>
