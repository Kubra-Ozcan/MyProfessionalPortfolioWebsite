      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-12 gap-8">
          <motion.div 
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="col-span-12 glass-panel rounded-3xl p-8 md:p-12 relative overflow-hidden bg-white/60 dark:bg-slate-900/40 border border-black/5 dark:border-white/10 shadow-2xl"
          >
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {RESUME_DATA.certificates.map((cert, index) => (
                  <div key={index} className="group relative cursor-default">
                    ...
                    <div className="relative h-full bg-white/80 dark:bg-[#0a0a1f]/80 backdrop-blur-sm border border-black/5 dark:border-white/10 p-5 rounded-xl flex items-center gap-4 transition-all duration-300 group-hover:-translate-y-1 group-hover:border-purple-500/20 dark:group-hover:border-white/20 group-hover:shadow-lg">
